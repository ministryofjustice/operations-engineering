...
def main():
    ...
    removed_users_entries = github_service.get_user_removal_events(one_week_ago, github_username)
    ...
    current_members = [username.lower() for username in github_service.get_org_members_login_names()]
