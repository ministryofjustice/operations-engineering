      ...
      "Statement" : [
        {
          ...
          "Resource" : "arn:aws:s3:::operations-engineering-test-terraform-state-bucket"
        },
        {
          "Effect" : "Allow",
          "Action" : ["s3:GetObject", "s3:PutObject"],
          "Resource" : "arn:aws:s3:::operations-engineering-test-terraform-state-bucket/terraform/dsd/cloudwatch_alarms/terraform.tfstate"
        }
      ]
    }
  )
