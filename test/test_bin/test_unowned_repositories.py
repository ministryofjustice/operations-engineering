...
@patch("bin.unowned_repositories.GithubService", new=MagicMock)
@patch("bin.unowned_repositories.SlackService", new=MagicMock)
@patch("bin.unowned_repositories.get_cli_arguments")
@patch("bin.unowned_repositories.get_unowned_repositories")
@patch("bin.unowned_repositories.send_slack_message")
