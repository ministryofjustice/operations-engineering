...
class TestDormantGitHubUser(unittest.TestCase):
    ...
    def test_last_github_activity_is_cached(self):
        ...
        self.github_service.get_last_audit_log_activity_date_for_user.return_value = last_activity_date
    ...
    def test_is_dormant_when_no_activities(self):
        self.github_service.get_last_audit_log_activity_date_for_user.return_value = None
    ...
    def test_is_not_dormant_when_recent_github_activity(self):
        self.github_service.get_last_audit_log_activity_date_for_user.return_value = datetime.now()
        self.user.fetch_last_auth0_activity = MagicMock(return_value=None)
    ...
    def test_is_not_dormant_when_recent_auth0_activity(self):
        ...
        self.user.fetch_last_auth0_activity = MagicMock(
    ...
    def test_is_dormant_when_all_activities_are_old(self):
        ...
        self.github_service.get_last_audit_log_activity_date_for_user.return_value = old_activity
        self.user.fetch_last_auth0_activity = MagicMock(
