...
from python.lib.moj_git_auth import MoJGitAuth
...
class TestMoJGitAuth(unittest.TestCase):
    ...
    def test_generate_installation_token_success(self, mock_post):
        ...
        mock_post.return_value.json.return_value = {"token": "installation_token"}
        ...
        self.assertEqual(expected_result, MoJGitAuth.generate_installation_token(installation_id, jwt_token))
    ...
    def test_get_app_install_id_success(self, mock_get):
        ...
        self.assertEqual(expected_result, MoJGitAuth.get_app_install_id(jwt_token))
