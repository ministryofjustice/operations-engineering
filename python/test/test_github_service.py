...
@patch("gql.Client.__new__", new=MagicMock)
@patch("github.Github.__new__", new=MagicMock)
class TestGithubServiceGetRepositoryInfo(unittest.TestCase):
    def setUp(self):
        self.return_data = {
            "search": {
                "repos": [
        ...
        self.expected_repo_data = ("some-repo", True, 1)
    ...
    def test_returns_correct_data(self):
        ...
        repos = github_service.get_repositories_info()
        self.assertEqual(len(repos), 3)
        self.assertEqual(repos, self.all_expected_repos_data)
    ...
    def test_repo_is_disabled(self):
        github_service = GithubService("", ORGANISATION_NAME)
